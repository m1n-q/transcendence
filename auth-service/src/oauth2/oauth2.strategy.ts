...
export class Oauth42Strategy extends PassportStrategy(oStrategy, 'oauth2-42') {
  constructor() {
    super({
      ...
      callbackURL: 'http://localhost:8000/auth/oauth2/42/result',
...
export class OauthGoogleStrategy extends PassportStrategy(
  ...
  constructor() {
    super({
      ...
      callbackURL: 'http://localhost:8000/auth/oauth2/google/result',
...
export class OauthKakaoStrategy extends PassportStrategy(
  ...
  constructor() {
    super({
      ...
      callbackURL: 'http://localhost:8000/auth/oauth2/kakao/result',
    });
  }
