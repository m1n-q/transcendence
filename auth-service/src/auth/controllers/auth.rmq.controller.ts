  ...
  async oauth42(msg: { code: string }) {
    const userProfile: any = await this.authService.oauth(
      msg.code,
      {
        ...
        redirectURI: 'http://localhost:3000/auth/oauth2/42/result',
  ...
  async oauthKakao(msg: { code: string }) {
    const userProfile: any = await this.authService.oauth(
      msg.code,
      {
        ...
        redirectURI: 'http://localhost:3000/auth/oauth2/kakao/result',
  ...
  async oauthGoogle(msg: { code: string }) {
    const userProfile: any = await this.authService.oauth(
      msg.code,
      {
        ...
        redirectURI: 'http://localhost:3000/auth/oauth2/google/result',
