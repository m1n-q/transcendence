...
export class Oauth42Strategy extends PassportStrategy(oStrategy, 'oauth2-42') {
  constructor() {
    super({
      ...
      callbackURL: 'http://localhost:56789/auth/oauth2/42/result',
...
//       callbackURL: 'http://localhost:56789/auth/oauth2/google/result',
...
//       callbackURL: 'http://localhost:56789/auth/oauth2/kakao/result',
//     });
//   }
